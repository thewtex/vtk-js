...
import vtkOffCenterInteractorStyle from '../../../Sources/Interaction/Style/OffCenterInteractorStyle';
...
const irenStyle = vtkOffCenterInteractorStyle.newInstance();
const actorBounds = actor.getBounds();

const actorCenter = [
  actorBounds[0] + ((actorBounds[1] - actorBounds[0]) / 2),
  actorBounds[2] + ((actorBounds[3] - actorBounds[2]) / 2),
  actorBounds[4] + ((actorBounds[5] - actorBounds[4]) / 2),
];

irenStyle.setCenterOfRotation(actorCenter);
